...
import MintSuccessModal, { MintedAssetInfo } from './MintSuccessModal'
...
export default function TokenizeAsset() {
  ...
  const handleMintNFT = async () => {
    ...
    try {
      ...
      console.error('Error in handleMintNFT:', e)
      const errorMsg = e.message || 'Unknown error'
      enqueueSnackbar(`Error uploading to backend: ${errorMsg}`, { variant: 'error' })
      setNftLoading(false)
      return
    }
